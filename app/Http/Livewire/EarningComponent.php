...
class EarningComponent extends Component
{
    ...
    public $earningId, $earningTypeId, $earningAmount;
    ...
    public function store()
    {
        ...
        $earning->earning_type_id = $this->earningTypeId;
    ...
    public function edit($earning)
    {
        ...
        $this->earningTypeId = $earning['earning_type_id'];
    ...
    {
        $this->employeeEarnings = Earning::with('earning_type')->where("employee_id", $this->empId)->get();
    }
    ...
    public function render()
    {
        ...
        $earningTypes = EarningType::orderBy("earning_name")->get();

        $this->employeeEarnings();

        return view('livewire.earning-component', [
